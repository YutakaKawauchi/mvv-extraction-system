          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3 h-auto">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-red-800 mb-2">課題</h5>
                <ul className="text-xs text-red-700 space-y-1">
                  {idea.leanCanvas.problem.map((item, index) => (
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-blue-800 mb-2">ソリューション</h5>
                <p className="text-xs text-blue-700">{idea.leanCanvas.solution}</p>
              </div>

              {/* 価値提案 */}
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 md:row-span-2">
                <h5 className="text-sm font-semibold text-yellow-800 mb-2">価値提案</h5>
                <p className="text-xs text-yellow-700">{idea.leanCanvas.valueProposition}</p>
              </div>

              {/* 競争優位性 */}
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-purple-800 mb-2">競争優位性</h5>
                <p className="text-xs text-purple-700">{idea.leanCanvas.unfairAdvantage}</p>
              </div>

              {/* 顧客セグメント */}
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-green-800 mb-2">顧客セグメント</h5>
                <ul className="text-xs text-green-700 space-y-1">
                  {idea.leanCanvas.targetCustomers.map((customer, index) => (
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-gray-800 mb-2">既存の選択肢</h5>
                <p className="text-xs text-gray-700">{idea.leanCanvas.existingAlternatives || '特になし'}</p>
              </div>

              {/* チャネル */}
              <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-indigo-800 mb-2">チャネル</h5>
                <ul className="text-xs text-indigo-700 space-y-1">
                  {idea.leanCanvas.channels.map((channel, index) => (
              ...
              <div className="bg-teal-50 border border-teal-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-teal-800 mb-2">アーリーアダプター</h5>
                <p className="text-xs text-teal-700">{idea.leanCanvas.earlyAdopters || '未設定'}</p>
              </div>

              {/* 主要指標 */}
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-orange-800 mb-2">主要指標</h5>
              ...
              {/* コスト構造 */}
              <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-red-800 mb-2">コスト構造</h5>
                <ul className="text-xs text-red-700 space-y-1">
                  {idea.leanCanvas.costStructure.map((cost, index) => (
              ...
              {/* 収益源 */}
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <h5 className="text-sm font-semibold text-green-800 mb-2">収益源</h5>
                <ul className="text-xs text-green-700 space-y-1">
                  {idea.leanCanvas.revenueStreams.map((revenue, index) => (
